...
def main():
    ...
    print('  → Check debate page: verumsignal.com/debates/')
    print('  → Monitor Railway cron: veris-api-refresh should fire every 5 min')
    print('    If provisional claims don\'t promote within 70 min, run manually:')
    print('    python3 railway_api_refresh.py')
    print()
